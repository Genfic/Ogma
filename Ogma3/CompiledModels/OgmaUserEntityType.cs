...
namespace CompiledModels
{
    internal partial class OgmaUserEntityType
    {
        ...
        var deletedAt = runtimeEntityType.AddProperty(
            ...
            nullable: true);
        deletedAt.TypeMapping = NpgsqlTimestampTypeMapping.Default.Clone(
    ...
    lastActive.TypeMapping = NpgsqlTimestampTypeMapping.Default.Clone(
        comparer: new ValueComparer<DateTime>(
...
var registrationDate = runtimeEntityType.AddProperty(
    ...
    valueGenerated: ValueGenerated.OnAdd,
    sentinel: new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified));
registrationDate.TypeMapping = NpgsqlTimestampTypeMapping.Default.Clone(
    comparer: new ValueComparer<DateTime>(
        (DateTime v1, DateTime v2) => v1.Equals(v2),
        (DateTime v) => v.GetHashCode(),
        (DateTime v) => v),
