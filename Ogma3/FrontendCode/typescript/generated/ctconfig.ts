// Auto-generated from CTConfig.cs — do not edit manually

export const MaxEmailAddressLength = "254";
export const ImageFileTypes = [".jpg", ".jpeg", ".png", ".webp", ".avif"];
export const ExtendedImageFileTypes = [".jpg", ".jpeg", ".png", ".webp", ".avif", ".gif", ".apng"];
export const Files = {
...
export const Story = {
	...
	MinTagCount: "3",
	MaxExtraTagsCount: "50",
	MaxExtraTagLength: "30",
	ValidateLengthMsg: "The {0} must be at least {2} and at most {1} characters long.",
