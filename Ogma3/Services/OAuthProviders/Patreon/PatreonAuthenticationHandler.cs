...
public sealed partial class PatreonAuthenticationHandler
(
	IOptionsMonitor<PatreonAuthenticationOptions> options,
	ILoggerFactory logger,
	UrlEncoder encoder)
	: OAuthHandler<PatreonAuthenticationOptions>(options, logger, encoder)
{
