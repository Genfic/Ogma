...
public enum EClubSortingOptions
{
	...
	[Display(Name = "Members ↑")] MembersAscending,
	[Display(Name = "Members ↓")] MembersDescending,

	[Display(Name = "Stories ↑")] StoriesAscending,
	[Display(Name = "Stories ↓")] StoriesDescending,

	[Display(Name = "Threads ↑")] ThreadsAscending,
