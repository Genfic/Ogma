...
export const Error_OnGet = async (code: number, headers?: HeadersInit, options?: RequestInit) =>
	await fetch(`/api/error?code=${code}`, {
		method: "GET",
		headers: {
...
export const ContentBlock_BlockStory = async (body: CommandOfStory, headers?: HeadersInit, options?: RequestInit) => await fetch (`/api/contentblock/story`, { 
	method: 'POST', 
	headers: { 
		'Content-Type': 'application/json', 
		...headers 
...
export const ContentBlock_BlockChapter = async (body: CommandOfChapter, headers?: HeadersInit, options?: RequestInit) => await fetch (`/api/contentblock/chapter`, { 
	method: 'POST', 
	headers: { 
		'Content-Type': 'application/json', 
		...headers 
...
export const ContentBlock_BlockBlogpost = async (body: CommandOfBlogpost, headers?: HeadersInit, options?: RequestInit) => await fetch (`/api/contentblock/blogpost`, { 
	method: 'POST', 
	headers: { 
		'Content-Type': 'application/json', 
		...headers 
...
export const CommentsThread_LockThread = async (body: CommentsThreadControllerPostData, headers?: HeadersInit, options?: RequestInit) => await fetch (`/api/commentsthread/lock`, { 
	method: 'POST', 
	headers: { 
		'Content-Type': 'application/json', 
		...headers 
