...
export const Chapter_LastChapter = async (sid: number, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<string>(`/story/${sid}/chapter/last`, "GET", undefined, headers, options);

export const Clubs_BanUser = async (body: BanUserCommand, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<boolean>("/api/clubs/user/ban", "POST", body, headers, options);

export const Clubs_GetClubsWithStory = async (id: number, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<GetClubsWithStoryResult[]>(`/api/clubs/story/${id}`, "GET", undefined, headers, options);

export const Clubs_GetUserClubs = async (headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<GetJoinedClubsResponse[]>("/api/clubs/user", "GET", undefined, headers, options);

export const Clubs_UnbanUser = async (body: UnbanUserCommand, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<boolean>("/api/clubs/user/ban", "DELETE", body, headers, options);

export const DeleteApiChaptersread = async (body: MarkChapterAsUnreadCommand, headers?: HeadersInit, options?: RequestInit) =>
...
export const DeleteApiShelfStories = async (body: RemoveBookFromShelfCommand, headers?: HeadersInit, options?: RequestInit) =>
...
export const Error_OnGet = async (code: number, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<ErrorControllerResult>(`/api/error?code=${code}`, "GET", undefined, headers, options);

export const Folders_AddStory = async (body: AddStoryToFolderCommand, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<AddStoryToFolderResponse>("/api/folders/add-story", "POST", body, headers, options);

export const Folders_GetFoldersOfClub = async (id: number, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<GetFolderResult[]>(`/api/folders/${id}`, "GET", undefined, headers, options);

export const GetAllQuotes = async (headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<QuoteDto[]>("/api/quotes", "GET", undefined, headers, options);
...
export const GetApiComments = async (thread: number, page: number, highlight: number, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<PaginationResultOfCommentDto>(
...
export const GetApiInviteCodesPaginated = async (page: number, perpage: number, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<InviteCodeDto[]>(`/api/invitecodes/paginated?page=${page}&perpage=${perpage}`, "GET", undefined, headers, options);
...
export const GetRatings = async (headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<RatingApiDto[]>("/ratings", "GET", undefined, headers, options);
...
export const PostApiChaptersread = async (body: MarkChapterAsReadCommand, headers?: HeadersInit, options?: RequestInit) =>
...
export const PostApiCommentsThreadLock = async (body: LockThreadCommand, headers?: HeadersInit, options?: RequestInit) =>
...
export const PostApiQuotesJson = async (body: CreateQuotesFromJsonQuery, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<number>("/api/quotes/json", "POST", body, headers, options);

export const PostApiRatings = async (parameters: unknown, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<RatingApiDto>(`/api/ratings?parameters=${parameters}`, "POST", undefined, headers, options);
...
export const PutApiRatings = async (parameters: unknown, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<RatingApiDto>(`/api/ratings?parameters=${parameters}`, "PUT", undefined, headers, options);
...
export const Subscriptions_IsSubscribedToThread = async (threadid: number, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<boolean>(`/api/subscriptions/thread?threadid=${threadid}`, "GET", undefined, headers, options);

export const Subscriptions_SubscribeThread = async (body: SubscribeCommentsThreadCommand, headers?: HeadersInit, options?: RequestInit) =>
	await typedFetch<boolean>("/api/subscriptions/thread", "POST", body, headers, options);

export const Subscriptions_UnsubscribeThread = async (
	body: UnsubscribeCommentsThreadCommand,
	headers?: HeadersInit,
	options?: RequestInit,
) => await typedFetch<boolean>("/api/subscriptions/thread", "DELETE", body, headers, options);
