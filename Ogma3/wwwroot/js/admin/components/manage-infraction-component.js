function u(t){return t===Object(t)}function m(t){return JSON.parse(JSON.stringify({...t,__isCopied__:!0}))}var n=(t)=>u(t)?m(t):t,r={log:(t)=>console.log(n(t)),info:(t)=>console.info(n(t)),warn:(t)=>console.warn(n(t)),error:(t)=>console.error(n(t)),debug:(t)=>console.debug(n(t))};async function o(t,a,i,c,p){let e=await fetch(t,{method:a,headers:{"Content-Type":"application/json",...c},body:i?JSON.stringify(i):null,...p}),l=e.headers.get("content-type"),s;if(l?.includes("application/json"))s=await e.json();else s=await e.text();return{ok:e.ok,status:e.status,statusText:e.statusText,headers:e.headers,data:s}}var d=async(t,a,i)=>await o("/admin/api/infractions","POST",t,a,i);Vue.component("manage-infraction",{props:{csrf:{type:String,required:!0},userId:{type:Number,required:!0},types:{type:Array,required:!0}},data:()=>({type:null,date:null,reason:null,visible:!1}),methods:{hide:function(){this.type=this.date=this.reason=null,this.visible=!1},create:async function(){if(r.log("submit"),!(await d({userId:this.userId,reason:this.reason,endDate:this.date,type:this.type},{RequestVerificationToken:this.csrf})).ok)return;location.reload()}},template:`
...
//# debugId=61F670DA5658F67464756E2164756E21
