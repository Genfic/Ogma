...
deleteNamespace:function(a){var b=this;axios.delete(this.route+"/"+a.id).then(function(a){b.getNamespaces()}).catch(function(a){console.log(a)})},editNamespace:function(a){this.form.name=a.name;this.form.color=a.color;this.form.color.a=0<a.color.a?(a.color.a/255).toFixed(2):0;this.form.id=a.id;this.updateColor()},cancelEdit:function(){this.form.name=this.form.color=this.form.id=null},updateColor:function(){this.color="rgba("+this.form.color.r+", "+this.form.color.g+", "+this.form.color.b+", "+this.form.color.a+
")"}},mounted:function(){var a=this;this.route=document.getElementById("route").dataset.route;axios.get(this.route+"/validation").then(function(b){a.lens=b.data}).catch(function(a){return console.error(a)});this.getNamespaces()}});function calculateColor(a){var b=Math.round(255*a.a).toString(16),c=a.r.toString(16),d=a.g.toString(16);a=a.b.toString(16);return parseInt(""+b+c+d+a,16)};
