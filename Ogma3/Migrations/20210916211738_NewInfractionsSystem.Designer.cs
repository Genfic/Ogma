...
namespace Ogma3.Migrations
{
    ...
    [Migration("20210916211738_NewInfractionsSystem")]
    partial class NewInfractionsSystem
    {
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasPostgresEnum(null, "e_notification_event", new[] { "system", "watched_story_updated", "watched_thread_new_comment", "followed_author_new_blogpost", "followed_author_new_story", "comment_reply" })
                .HasPostgresEnum(null, "e_story_status", new[] { "in_progress", "completed", "on_hiatus", "cancelled" })
                .HasPostgresEnum(null, "e_tag_namespace", new[] { "content_warning", "genre", "franchise" })
                .HasPostgresEnum(null, "infraction_type", new[] { "note", "warning", "mute", "ban" })
