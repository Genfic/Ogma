...
public partial class StoryEntityType
{
    public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
    {
        ...
        var isLocked = runtimeEntityType.AddProperty(
            "IsLocked",
            typeof(bool),
            propertyInfo: typeof(Story).GetProperty("IsLocked", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
        ...
        CreditsComplexProperty.Create(runtimeEntityType);
    ...
    public static class CreditsComplexProperty
    {
        public static RuntimeComplexProperty Create(RuntimeEntityType declaringType)
        {
            var complexProperty = declaringType.AddComplexProperty("Credits",
                typeof(List<Credit>),
                "Ogma3.Data.Stories.Story.Credits#Credit",
                typeof(Credit),
            ...
            var link = complexType.AddProperty(
                "Link",
                typeof(string),
            ...
            var role = complexType.AddProperty(
                "Role",
                typeof(string),
            ...
            complexType.AddAnnotation("Relational:ContainerColumnName", "Credits");
            ...
            complexType.AddAnnotation("Relational:TableName", "Stories");
    ...
    {
        var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("CoverId") },
            principalEntityType.FindKey(new[] { principalEntityType.FindProperty("Id") }),
            principalEntityType);

        var cover = declaringEntityType.AddNavigation("Cover",
            runtimeForeignKey,
            onDependent: true,
            typeof(Image),
