...
public partial class InviteCodeEntityType
{
    public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
    {
        ...
        var code = runtimeEntityType.AddProperty(
            ...
            fieldInfo: typeof(InviteCode).GetField("<Code>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            maxLength: 20);
        ...
        var issuedByType = runtimeEntityType.AddProperty(
            "IssuedByType",
            typeof(string),
            propertyInfo: typeof(InviteCode).GetProperty("IssuedByType", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(InviteCode).GetField("<IssuedByType>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            nullable: true,
            maxLength: 32);
        issuedByType.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
