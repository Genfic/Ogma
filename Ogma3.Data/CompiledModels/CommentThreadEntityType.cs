...
public partial class CommentThreadEntityType
{
    public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
    {
        ...
        var lastChange = runtimeEntityType.AddProperty(
            ...
            propertyInfo: typeof(CommentThread).GetProperty("LastChange", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(CommentThread).GetField("<LastChange>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            valueGenerated: ValueGenerated.OnAdd,
    ...
    public static RuntimeForeignKey CreateForeignKey1(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
    {
        ...
        var commentThread = principalEntityType.AddNavigation("CommentThread",
            ...
            onDependent: false,
            typeof(CommentThread),
            propertyInfo: typeof(Blogpost).GetProperty("CommentThread", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Blogpost).GetField("<CommentThread>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
    ...
    public static RuntimeForeignKey CreateForeignKey2(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
    {
        ...
        var commentThread = principalEntityType.AddNavigation("CommentThread",
            ...
            onDependent: false,
            typeof(CommentThread),
            propertyInfo: typeof(Chapter).GetProperty("CommentThread", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(Chapter).GetField("<CommentThread>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
    ...
    public static RuntimeForeignKey CreateForeignKey3(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
    {
        ...
        var commentThread = principalEntityType.AddNavigation("CommentThread",
            ...
            onDependent: false,
            typeof(CommentThread),
            propertyInfo: typeof(ClubThread).GetProperty("CommentThread", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(ClubThread).GetField("<CommentThread>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
    ...
    public static RuntimeForeignKey CreateForeignKey4(RuntimeEntityType declaringEntityType, RuntimeEntityType principalEntityType)
    {
        ...
        var commentThread = principalEntityType.AddNavigation("CommentThread",
            ...
            onDependent: false,
            typeof(CommentThread),
            propertyInfo: typeof(OgmaUser).GetProperty("CommentThread", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(OgmaUser).GetField("<CommentThread>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
