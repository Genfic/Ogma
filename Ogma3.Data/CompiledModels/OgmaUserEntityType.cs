...
public partial class OgmaUserEntityType
{
    public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
    {
        ...
        var subscriptionId = runtimeEntityType.AddProperty(
            "SubscriptionId",
            typeof(long?),
            propertyInfo: typeof(OgmaUser).GetProperty("SubscriptionId", BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            fieldInfo: typeof(OgmaUser).GetField("<SubscriptionId>k__BackingField", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly),
            nullable: true);
        ...
        var index1 = runtimeEntityType.AddIndex(
            new[] { normalizedEmail });
        index1.AddAnnotation("Relational:Name", "EmailIndex");
    ...
    {
        var runtimeForeignKey = declaringEntityType.AddForeignKey(new[] { declaringEntityType.FindProperty("AvatarId") },
            principalEntityType.FindKey(new[] { principalEntityType.FindProperty("Id") }),
            principalEntityType,
            deleteBehavior: DeleteBehavior.Cascade,
            required: true);

        var avatar = declaringEntityType.AddNavigation("Avatar",
            runtimeForeignKey,
            onDependent: true,
            typeof(Image),
