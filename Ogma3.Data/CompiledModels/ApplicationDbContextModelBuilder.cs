...
public partial class ApplicationDbContextModel
{
    private ApplicationDbContextModel()
        : base(skipDetectChanges: false, modelId: new Guid("f1db23cf-2793-45f2-9aeb-08f2af952560"), entityTypeCount: 46)
    {
    }
    ...
    partial void Initialize()
    {
        ...
        IdentityUserPasskeyEntityType.CreateForeignKey1(identityUserPasskey, ogmaUser);
        ...
        ClubEntityType.CreateForeignKey1(club, image);
        ...
        StoryEntityType.CreateForeignKey3(story, image);
        StoryEntityType.CreateForeignKey4(story, rating);
