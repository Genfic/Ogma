...
public partial class ChaptersReadEntityType
{
    public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
    {
        ...
        var _chaptersInternal = runtimeEntityType.AddProperty(
            "_chaptersInternal",
            typeof(List<long>),
            fieldInfo: typeof(ChaptersRead).GetField("_chaptersInternal", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.DeclaredOnly));
        var _chaptersInternalElementType = _chaptersInternal.SetElementType(typeof(long));
        _chaptersInternal.AddAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
        _chaptersInternal.AddAnnotation("Relational:ColumnName", "Chapters");
